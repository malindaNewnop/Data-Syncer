...
if exist "bin\Release" (
    ...
    "%WINDIR%\Microsoft.NET\Framework\v2.0.50727\installutil.exe" "bin\Release\syncer.service.exe"
) else if exist "bin\Debug" (
    echo Using Debug build...
    "%WINDIR%\Microsoft.NET\Framework\v2.0.50727\installutil.exe" "bin\Debug\syncer.service.exe"
) else (
...
if exist "bin\Release" (
    "%WINDIR%\Microsoft.NET\Framework\v2.0.50727\installutil.exe" /u "bin\Release\syncer.service.exe"
) else if exist "bin\Debug" (
    "%WINDIR%\Microsoft.NET\Framework\v2.0.50727\installutil.exe" /u "bin\Debug\syncer.service.exe"
) else (
