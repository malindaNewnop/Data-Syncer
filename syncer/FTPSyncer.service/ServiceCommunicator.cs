...
namespace FTPSyncer.service
{
    ...
    public class ServiceCommunicator : IDisposable
    {
        ...
        private FTPSyncer.core.IJobRunner _jobRunner;
        private FTPSyncer.core.ILogService _logService;
        ...
        public ServiceCommunicator(FTPSyncer.core.IJobRunner jobRunner, FTPSyncer.core.ILogService logService)
        {
