...
namespace FTPSyncer.service
{
    ...
    public class ServiceManager
    {
        ...
        private static void ShowCommandLineHelp()
        {
            ...
            Console.WriteLine("=========================");
            Console.WriteLine();
            Console.WriteLine("Usage: FTPSyncer.service.exe [command]");
            Console.WriteLine();
            ...
            Console.WriteLine("  FTPSyncer.service.exe install");
            Console.WriteLine("  FTPSyncer.service.exe start");
            Console.WriteLine("  FTPSyncer.service.exe status");
            Console.WriteLine();
