    ...
    public class SyncJobService : ISyncJobService
    {
        ...
        private void ExecuteUploadTransfer(SyncJob job)
        {
            try
            {
                ...
                FTPSyncer.core.ITransferClient transferClient = null;
                ...
                {
                    case "FTP":
                        transferClient = new FTPSyncer.core.Transfers.EnhancedFtpTransferClient();
                        break;
                    case "SFTP":
                        transferClient = new FTPSyncer.core.Transfers.ProductionSftpTransferClient();
                        break;
                    default:
        ...
        private FTPSyncer.core.ConnectionSettings ConvertToConnectionSettings(ConnectionSettings uiSettings)
        {
        ...
        private FTPSyncer.core.ProtocolType ConvertProtocolType(string protocol)
        {
            switch (protocol.ToUpper())
            {
                case "LOCAL": return FTPSyncer.core.ProtocolType.Local;
                case "FTP": return FTPSyncer.core.ProtocolType.Ftp;
                case "SFTP": return FTPSyncer.core.ProtocolType.Sftp;
                default: return FTPSyncer.core.ProtocolType.Local;
            }
        }
            ...
            try
            {
                ...
                switch (sourceConnection.Protocol.ToUpper())
                {
                    ...
                    case "SFTP":
                        ...
                        break;
                    case "LOCAL":
                        transferClient = new FTPSyncer.core.LocalTransferClient();
                        break;
                    default:
