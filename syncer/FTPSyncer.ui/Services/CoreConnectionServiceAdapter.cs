...
namespace FTPSyncer.ui.Services
{
    ...
    {
        private readonly FTPSyncer.core.ITransferClientFactory _transferClientFactory;
        ...
        public CoreConnectionServiceAdapter()
        {
            try
            {
                _transferClientFactory = FTPSyncer.core.ServiceFactory.CreateTransferClientFactory();
        ...
        public bool TestConnection(ConnectionSettings settings)
        {
            try
            {
                ...
                {
                    Protocol = (FTPSyncer.core.ProtocolType)settings.ProtocolType,
                    Host = settings.Host,
                    Port = settings.Port,
                ...
                var client = _transferClientFactory.Create((FTPSyncer.core.ProtocolType)settings.ProtocolType);
