...
namespace FTPSyncer.ui
{
    public partial class FormMain : Form
    {
        ...
        /// </summary>
        public void ApplyBandwidthLimitsToSftpConfig(FTPSyncer.core.Configuration.SftpConfiguration config, bool isUpload)
        {
            try
            {
        ...
        /// </summary>
        public FTPSyncer.core.Configuration.SftpConfiguration CreateBandwidthLimitedSftpConfig(bool isUpload)
        {
            var config = new FTPSyncer.core.Configuration.SftpConfiguration();
