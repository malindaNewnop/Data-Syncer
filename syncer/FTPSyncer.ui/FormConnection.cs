    ...
    public partial class FormConnection : Form
    {
        ...
        private bool TestConnectionWithTransferEngines(ConnectionSettings uiSettings)
        {
            try
            {
                ...
                {
                    case 0: // LOCAL
                        coreSettings.Protocol = FTPSyncer.core.ProtocolType.Local;
                        return TestLocalConnection(); // Special handling for local
                    case 1: // FTP
                        coreSettings.Protocol = FTPSyncer.core.ProtocolType.Ftp;
                        break;
                    case 2: // SFTP
                        coreSettings.Protocol = FTPSyncer.core.ProtocolType.Sftp;
                        break;
                    default:
                        return false;
                }
                ...
                {
                    coreSettings.Port = (coreSettings.Protocol == FTPSyncer.core.ProtocolType.Ftp) ? 21 : 22;
                }
                ...
                FTPSyncer.core.ITransferClient client = null;
                try
                {
                    switch (coreSettings.Protocol)
                    {
                        case FTPSyncer.core.ProtocolType.Ftp:
                            client = new FTPSyncer.core.Transfers.EnhancedFtpTransferClient();
                        ...
                        case FTPSyncer.core.ProtocolType.Sftp:
                            client = new FTPSyncer.core.Transfers.ProductionSftpTransferClient();
