...
namespace FTPSyncer.ui
{
    public partial class FormSchedule : Form
    {
        ...
        private FTPSyncer.core.ConnectionSettings _coreConnectionSettings;
        ...
        */
        ...
        private void BrowseRemoteFolderForDownloadImproved()
        {
            ...
            if (_coreConnectionSettings.Protocol == FTPSyncer.core.ProtocolType.Local)
            {
        ...
        private void UpdateTransferClient()
        {
            ...
            try
            {
                var factory = FTPSyncer.core.ServiceFactory.CreateTransferClientFactory();
        ...
        private FTPSyncer.core.ConnectionSettings ConvertToCore(ConnectionSettings uiSettings)
        {
            return new FTPSyncer.core.ConnectionSettings
            {
                Protocol = uiSettings.Protocol == "SFTP" ? FTPSyncer.core.ProtocolType.Sftp :
                          uiSettings.Protocol == "FTP" ? FTPSyncer.core.ProtocolType.Ftp :
