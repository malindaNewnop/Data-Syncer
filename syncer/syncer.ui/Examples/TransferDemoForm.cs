...
namespace syncer.ui.Examples
{
    ...
    public partial class TransferDemoForm : Form
    {
        ...
        private void TestConnection(syncer.core.ConnectionSettings settings, string connectionType)
        {
            try
            {
        ...
        private syncer.core.ConnectionSettings GetSourceConnectionSettings()
        {
            return new syncer.core.ConnectionSettings
            {
                Protocol = (syncer.core.ProtocolType)cmbSourceProtocol.SelectedIndex,
        ...
        private syncer.core.ConnectionSettings GetDestinationConnectionSettings()
        {
            return new syncer.core.ConnectionSettings
            {
                Protocol = (syncer.core.ProtocolType)cmbDestProtocol.SelectedIndex,
        ...
        private syncer.core.ConnectionSettings ConvertToCore(syncer.core.ConnectionSettings settings)
        {
