    ...
    public class CoreServiceManagerAdapter : IServiceManager
    {
        ...
        public CoreServiceManagerAdapter()
        {
            try
            {
                ...
                _coreLogService = syncer.core.ServiceFactory.CreateLogService();
                var jobRunner = syncer.core.ServiceFactory.CreateJobRunnerFromConfiguration();
                ...
                if (_multiJobRunner == null)
                {
                    ...
                    _multiJobRunner = syncer.core.ServiceFactory.CreateMultiJobRunner();
                }
