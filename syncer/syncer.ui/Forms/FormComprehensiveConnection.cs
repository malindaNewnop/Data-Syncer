...
namespace syncer.ui.Forms
{
    ...
    {
        private syncer.core.ConnectionSettings _settings;
        ...
        public syncer.core.ConnectionSettings ConnectionSettings => _settings;
        ...
        {
            InitializeComponent();
            _settings = new syncer.core.ConnectionSettings();
            PopulateFormFromSettings();
        }

        public FormComprehensiveConnection(syncer.core.ConnectionSettings existingSettings)
        {
            InitializeComponent();
            _settings = existingSettings ?? new syncer.core.ConnectionSettings();
            PopulateFormFromSettings();
        }
        ...
        private void UpdateSettingsFromForm()
        {
            ...
            _settings.Protocol = (syncer.core.ProtocolType)cmbProtocol.SelectedIndex;
